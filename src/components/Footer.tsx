...
const Footer = () => {
  return (
    <footer className="p-6 md:p-8 lg:p-10 mt-20 border-t border-gray-300">
      <div className="mx-auto max-w-screen-xl text-center flex flex-col items-center">
        ...
        {/* Description */}
        <p className="mt-3 mb-5 text-gray-500 text-sm md:text-base max-w-md">
          Code Rev. A platform where you can submit your code and get reviews.
        </p>

        {/* Links Section */}
        <ul className="flex flex-wrap justify-center gap-4 sm:gap-6 text-sm md:text-base text-gray-900">
          <li>
        ...
        {/* Copyright Text */}
        <span className="mt-4 text-xs md:text-sm text-gray-500 ">
          © 2024-2025{" "}
